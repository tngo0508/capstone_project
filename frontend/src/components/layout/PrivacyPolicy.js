...
export default function PrivacyPolicy() {
  return (
    <div className="container m-5">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BrandValueAnalysis.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to BrandValueAnalysis, accessible
            from{" "}
            <a
              href="http://www.brandvalueanalysis.com"
              rel="external nofollow noopener"
            >
              http://www.brandvalueanalysis.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: brandvalueanalysis@gmail.com</li>
      </ul>
    </div>
  );
}
