...
export default function TermsOfUse() {
  return (
    <div className="container m-5">
      ...
      <p>
        The BrandValueAnalysis website located at www.brandvalueanalysis.com is
        a copyrighted work belonging to BrandValueAnalysis. Certain features of
      ...
      <p>
        ...
        the Company should be sent to: 800 N State College Blvd, Fullerton, CA
        92831. After the Notice is received, you and the Company may attempt to
      ...
      <p>Email: brandvalueanalysis@gmail.com</p>
    </div>
  );
}
